...
- `$caracteres` — a data frame with a `Species` column and one column per character.
...
Use `load_data(..., normalizar_espacios = TRUE)` to convert spaces to `_` automatically before matching.
